...
const Register = ()=>{
    ...
    return(
        <div className="flex w-full bg-white bg-opacity-75  min-h-screen">
         ...
         <div className="flex items-center">  
                ...
                <label htmlFor="female" className="cursor-pointer text-gray-700">Female</label>  
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        type='submit' 
                        disabled={isValid}
                        className={`text-white cursor-grab font-bold py-2 px-4 mt-3 rounded-lg focus:outline-none focus:shadow-outline w-full ${isValid?'bg-emerald-500':'bg-gray-200'}`}
